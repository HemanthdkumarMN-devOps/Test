...
public class App {
	...
	// Create NFT Page
		    ...
		    driver.findElement(By.xpath("/html/body/div/div/div/div[3]/div[1]/div[1]/div/div[1]/div/input")).sendKeys("/var/lib/jenkins/workspace/Qa/test/test-output/Screenshot (322).png");
