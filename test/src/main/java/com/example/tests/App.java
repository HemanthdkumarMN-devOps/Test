...
// Create NFT Page [Private]    
        ...
        driver.findElement(By.xpath("/html/body/div/div/div/div[3]/div[1]/div[1]/div/div[1]/div/input"))
                .sendKeys("/var/lib/jenkins/workspace/Qa/test/test-output/jenkins.png");
...
// Give file Path..
            driver.findElement(By.xpath("//div[@id='root']/div/div/div[3]/div[2]/div[2]/input")).sendKeys("/var/lib/jenkins/workspace/Qa/test/test-output/jenkins.png");
            driver.findElement(By.name("bio")).click();
            driver.findElement(By.name("bio")).clear();
            driver.findElement(By.name("bio")).sendKeys("test bio auto");

// Give file Path.. 
            driver.findElement(By.xpath("/html/body/div/div/div/div[3]")).click(); 
             driver.findElement(By.xpath("/html/body/div/div/div/div[3]/div[1]/div[1]/div/div/button")).sendKeys("/var/lib/jenkins/workspace/Qa/test/test-output/jenkins.png");
